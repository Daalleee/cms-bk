                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.tahapan-penanganan.update', $tahapan) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4" id="video-container">
                            ...
                            <div id="video-list">
                                @forelse($videoUrls as $url)
                                    <div class="flex items-center gap-2 mb-2 video-item">
                                        <input type="url" name="video_urls[]" value="{{ $url }}" class="flex-1 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm text-sm" placeholder="https://www.youtube.com/watch?v=..." />
                                        <button type="button" onclick="hapusVideo(this)" class="text-red-600 hover:text-red-800 shrink-0">
