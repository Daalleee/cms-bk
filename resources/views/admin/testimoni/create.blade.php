                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.testimoni.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="isi_testimoni" name="isi_testimoni" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" rows="4" required>{{ old('isi_testimoni') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="status_publikasi" name="status_publikasi" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                <option value="1" {{ old('status_publikasi') == '1' ? 'selected' : '' }}>Ditampilkan</option>
                                <option value="0" {{ old('status_publikasi') == '0' ? 'selected' : '' }}>Menunggu</option>
                            </select>
